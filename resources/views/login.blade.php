                            ...
                            <div class="card-body p-5">
                                ...
                                <!-- Email input -->
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button type="submit" class="btn btn-success btn-block btn-lg text-body" style="margin: auto">Sign in</button>
                                    </div>
                                    <!-- Register buttons -->
                                    <div class="text-center mt-4">
                                        <p>Not a member? <a class="text-body"href="/register">Register</a></p>
                                    </div>
                                </form>
                            </div>
                        </div>
