<nav style="padding: .5em" class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <ul class="navbar-nav">
        <li style="display:flex; justify-content: center; align-items: center;">
            <a style="position:relative;"href="{{ route('cart') }}">
                ...
                @if(isset($cart)) 
                    <div style=" background-color: red; width: 1em; height: 1em; justify-content: center; align-items: center; border-radius: 50%">
                        <p style="display: block"> {{ count($cart) }} </p>
                    </div>
                @endif
